...
class EdgeNeXtXSmall(Model):
    def __init__(
        ...
        backbone = timm.create_model(
            "edgenext_x_small", pretrained=True, num_classes=0, in_chans=1 if grayscale else 3
        )
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(root / "configs" / "model" / "edgenext.yaml")
