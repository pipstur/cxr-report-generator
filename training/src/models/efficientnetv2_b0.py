...
class EfficientNetV2B0(Model):
    def __init__(
        ...
        backbone = timm.create_model(
            "tf_efficientnetv2_b0", pretrained=True, num_classes=0, in_chans=1 if grayscale else 3
        )
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(root / "configs" / "model" / "efficientnetv2_b0.yaml")
